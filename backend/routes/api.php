...
use App\Http\Controllers\TaskProgressionController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Task Progressions
    Route::get('/task-progressions', [TaskProgressionController::class, 'index']);
    Route::post('/task-progressions', [TaskProgressionController::class, 'store']);
    Route::post('/task-progressions/reorder', [TaskProgressionController::class, 'reorder']);
});
